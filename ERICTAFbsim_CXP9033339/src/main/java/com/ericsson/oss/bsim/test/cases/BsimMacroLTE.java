...
public class BsimMacroLTE extends TorTestCaseHelper implements TestCase {

    private static Logger log = Logger.getLogger(BsimMacroLTE.class);
    ...
    @Test(dataProvider = "newMacroLTENodes", dataProviderClass = BsimTestData.class, groups = { "VCDB" })
