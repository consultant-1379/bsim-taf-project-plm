...
public class BsimMacroLTEDataProvider extends BsimDataProvider {

    private static Logger log = Logger.getLogger(BsimMacroLTEDataProvider.class);

    public static final String DATA_FILE = DataHandler.getAttribute("dataprovider.ADD_MACRO_LTE.location").toString();

    public static final String DATA_FILE_QUICK = DataHandler.getAttribute("dataprovider.ADD_LTE_QUICK_FEEDBACK.location").toString();
    ...
    protected LinkedHashMap<String, String> createAddNodeDataBasicAttrs(final String templateName) {
        ...
        log.info(String.format("Invoking : BsimMacroLTEDataProvider.createAddNodeDataBasicAttrs(%s)", templateName));
    ...
    public LinkedHashMap<String, String> createNodeTemplateAttributes(final String templateName) {
        ...
        log.info(String.format("Invoking : BsimMacroLTEDataProvider.createNodeTemplateAttributes(%s)", templateName));
    ...
    protected LinkedHashMap<String, String> getTransportTemplateAttributesByTemplateName(
        ...
        if (templateName == null || templateName == "") {
            log.warn("Invoking : BsimMacroLTEDataProvider.getTransportTemplateAttributesByTemplateName : No template received");
        } else {
            log.info(String.format("Invoking : BsimMacroLTEDataProvider.getTransportTemplateAttributesByTemplateName(%s)", templateName));
            ...
            switch (templateName.toLowerCase()) {
                ...
                default:
                    log.warn(String.format(
                            "Invoking : BsimMacroLTEDataProvider.getTransportTemplateAttributesByTemplateName(%s) : invalid template name, not processed",
                            templateName));
                    break;
            }
        }
    ...
    protected LinkedHashMap<String, String> getRadioTemplateAttributesByTemplateName(
        ...
        if (templateName == null || templateName == "") {
            log.warn("Invoking : BsimMacroLTEDataProvider.getRadioTemplateAttributesByTemplateName : No template received");
        } else {
            log.info(String.format("Invoking : BsimMacroLTEDataProvider.getRadioTemplateAttributesByTemplateName(%s)", templateName));
            ...
            switch (templateName.toLowerCase()) {
                ...
                default:
                    log.warn(String.format(
                            "Invoking : BsimMacroLTEDataProvider.getRadioTemplateAttributesByTemplateName(%s) : invalid template name, not processed",
                            templateName));
                    break;
            }
        }
