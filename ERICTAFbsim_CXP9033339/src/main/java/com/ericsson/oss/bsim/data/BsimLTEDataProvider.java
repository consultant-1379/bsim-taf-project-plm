...
public class BsimLTEDataProvider extends BsimDataProvider {

    private static Logger log = Logger.getLogger(BsimLTEDataProvider.class);

    public static final String DATA_FILE = DataHandler.getAttribute("dataprovider.ADD_LTE.location").toString();
