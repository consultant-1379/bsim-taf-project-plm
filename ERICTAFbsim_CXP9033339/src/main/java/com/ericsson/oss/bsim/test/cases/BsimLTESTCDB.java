...
public class BsimLTESTCDB extends TorTestCaseHelper implements TestCase {

    private static Logger log = Logger.getLogger(BsimLTESTCDB.class);
    ...
    @Test(dataProvider = "newStCdbLTENodes", dataProviderClass = BsimTestData.class, groups = { "KGB" })
